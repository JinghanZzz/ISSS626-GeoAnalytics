---
title: "Hands-on Exercise 10b --Chapter 16 Calibrating Spatial Interaction Models with R" 
...
讲怎么选合适的参to improve model performance的
...
In spatial interaction, a distance matrix is a table that shows the distance between pairs of locations. For example, in the table below we can see an Euclidean distance of 3926.0025 between MESZ01 and RVSZ05, of 3939.1079 between MESZ01 and SRSZ01, and so on. By definition, an location’s distance from itself, which is shown in the main diagonal of the table, is 0. 自己到自己是0
...
Next, [`spDists()`](https://www.rdocumentation.org/packages/sp/versions/2.1-1/topics/spDistsN1) of sp package will be used to compute the Euclidean distance between the centroids of the planning subzones. Use centriod to simplify calculation. also distance should be between 2 points
...
```{r}
pop <- pop %>%   left_join(mpsz,             by = c("PA" = "PLN_AREA_N",                    "SZ" = "SUBZONE_N")) %>%   select(1:6) %>%   rename(SZ_NAME = SZ,          SZ = SUBZONE_C)
```
...
![](images/clipboard-3573901107.png)
...
![](images/clipboard-1172605297.png)
...
examine the constraints hold for destinations this time
...
![](images/clipboard-1020983622.png)
...
![](images/clipboard-3434414519.png)
...
Repeat for Origin Constrained SIM
...
Reprat for DEstination Constrained SIM
