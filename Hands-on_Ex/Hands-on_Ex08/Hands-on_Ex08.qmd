---
title: "Hands-on Exercise 07 --14  Geographically Weighted Predictive Models" 
...
### **14.4.2 Data Sampling (split to test and train set)**
...
First, we will drop geometry column of the sf data.frame by using `st_drop_geometry()` of sf package. 为什么要drop呢
