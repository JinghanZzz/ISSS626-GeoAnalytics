---
title: "Hands-on Exercise 07 --13.Calibrating Hedonic Pricing Model for Private Highrise Property with GWR Method" 
...
look at impact of factors like climate, demographic factors, etc. on indicators.

GWR modeling

structural factor: number of rooms, etc.

location factor: near mtr or not
...
MP14_SUBZONE_WEB_PL. It is in ESRI shapefile format.
...
#### 13.8.5.1 Checking for multicolinearity (using olsrr package)
