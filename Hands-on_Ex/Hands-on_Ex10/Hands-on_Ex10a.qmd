---
title: "Hands-on Exercise 10 --Chapter 15  Processing and Visualising Flow Data" 
...
Pick your time, extract origin, destination and count

For the purpose of this exercise, we will extract commuting flows on weekday and between 6 and 9 o’clock.

```{r}
odbus6_9 <- odbus %>% filter(DAY_TYPE == "WEEKDAY") %>% filter(TIME_PER_HOUR >= 6 & TIME_PER_HOUR <= 9) %>% group_by(ORIGIN_PT_CODE, DESTINATION_PT_CODE) %>% summarise(TRIPS = sum(TOTAL_TRIPS))
```
...
clearify the busstop belongs to which subzone
