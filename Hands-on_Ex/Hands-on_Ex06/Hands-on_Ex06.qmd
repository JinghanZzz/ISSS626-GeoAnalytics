---
title: "Hans-on_Ex06--12  Geographical Segmentation with Spatially Constrained Clustering Techniques"
...
不要直接算拥有量，因为受total number of household影响很大
...
用这个group：undefined[ ](https://rpkgs.datanovia.com/ggpubr/reference/ggarrange.html)[ ](https://rpkgs.datanovia.com/ggpubr/index.html)
...
Now let us plot the choropleth maps showing the dsitribution of total number of households and Radio penetration rate by using the code chunk below.直接看实际数不可比，plot个penetration rate的出来
...
### **12.7.5 Visualising the standardised clusterin**
...
#### 12.7.9.1 Gap Statistic Method (largest within group)
